...

{
    ...
    var sealContainer = document.getElementById("sealContainer");
    if (sealContainer != null) {
        sealContainer.innerHTML = "<a HREF=\"" + u1 + "\" tabindex=\"-1\" onmousedown=\"return mouseDown();\" target=\"VRSN_Splash\"><IMG NAME=\"seal\" BORDER=\"true\" SRC=\"" + seal_gif_url + "\" oncontextmenu=\"return false;\"></A>";
    }
